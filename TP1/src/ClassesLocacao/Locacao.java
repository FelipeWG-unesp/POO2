...
public class Locacao {
    ...
    public Locacao(int codigoLocacao, Cliente codigoCliente, Funcionario codigoFuncionario, LocalDate dataLocacao, LocalDate dataDevolucao, float valorTotal, Pagamento formaPagamento, ArrayList<Seguro> segurosContratados, boolean finalizada) {
